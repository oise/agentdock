...
export function TabOverflowMenu({
  ...
  return (
    ...
    >
      {tabs.length > 0 && (
        <div className='mb-1'>
          <div className='text-ide-small px-5 py-1 text-[var(--ide-Label-disabledForeground)]'>Open Tabs</div>
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <button
                  ...
                  role='menuitem'
                >
                  <span className='mr-2 flex items-center justify-center'>{getTabIcon(tab, agents)}</span>
      ...
      <div>
        <div className='text-ide-small px-5 py-1 text-[var(--ide-Label-disabledForeground)]'>New Chat</div>
          ...
          runnableAgents.map((agent) => (
            ...
            >
              <button
                ...
                role='menuitem'
              >
                <span className='mr-2 flex items-center justify-center'>{getAgentIcon(agent.id, agents)}</span>
